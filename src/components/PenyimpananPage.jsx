...
import { getSentReports, getSentReportsSync, deleteSentReport } from '../utils/reportArchive';
...
export default function PenyimpananPage() {
  ...
  useEffect(() => {
    // Tampilkan data cache dulu agar langsung ada isi, lalu refresh dari server
    setReports(getSentReportsSync());
    loadReports();
  }, []);
